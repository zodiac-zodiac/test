...
ex_text_str = " Technique : M3 :  Lock down your environment Specifics : Tampering requires modifying content of a local file, which requires access to the host, which requires an account and access credentials. Remaining Risk : Depends on proper OS account management. Verification : Built-in OS security feature."
